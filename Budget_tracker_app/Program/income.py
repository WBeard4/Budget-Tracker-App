...
class Income():
    ...
    def add(self):
        ...
        """
        item = input("Income Source: ")
        amount = float(input("How much did was this income?: £"))
    ...
    def view(self):
        """
        Calls database function to list all incomes
        """
        print("Here is a list of your incomes: \n")
        self.database.view_income()

    def categories(self):
        """
        Calls database function to list all incomes by category
        """
        print("Here is a list of your incomes ordered by category: \n")
        self.database.income_categories()